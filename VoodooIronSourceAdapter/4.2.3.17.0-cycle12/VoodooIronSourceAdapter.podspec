Pod::Spec.new do |s|
	...
	s.source = {
	  :http => "https://framework.voodoo-adn-dev.com/iOS/adapter/LevelPlay/4.2.3.17.0-cycle12/Adapter.zip"
	}
	s.platform = [:ios, "14.0"]
	...
	s.dependency 'VoodooAdn', '>= 3.17.0-cycle12'
  end